...
public interface IMolino extends IObservableRemoto {
    ...
    boolean hayFichasParaEliminarDelOponente(Jugador jugador) throws RemoteException;
    ...
    Jugador obtenerOponente(Jugador jugadorLocal) throws RemoteException;
    String nombreJugadorDelMolino() throws RemoteException;
    ...
    boolean casillaOcupadaPorJugadorLocal(Coordenada coordenada, Jugador jugador) throws RemoteException;
    boolean casillaOcupadaPorOponente(Coordenada coordenada, Jugador jugador) throws RemoteException;
